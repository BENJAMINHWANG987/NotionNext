...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个联盟营销人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.benfree.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ben的联盟营销, 博客', // 网站关键词 英文逗号隔开
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.benfree.top', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
